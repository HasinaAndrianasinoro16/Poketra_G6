...
<html>
    ...
    <%
        ArrayList<Reste> r = (ArrayList<Reste>)request.getAttribute("reste");
    %>
    <body class="container-fluid bg-dark text-start text-light" >
        ...
        <table class="table table-dark  table-hover text-light text-center container">
          ...
          <tr>
            ...
            <th scope="col">Quantite utile</th>
            <!--<th scope="col"> -- </th>-->
          </tr>
          </thead>
          <tbody>
          ...
          <tr>
            <th scope="row"><%= i+1 %></th>
            <td><%= r.get(i).getCodeMatiere() %></td>
            <td><%= r.get(i).getMatiere() %></td>
            <td><%= r.get(i).getQte() %></td>
          </tr>
          <% }%>
          </tbody>
        </table>
